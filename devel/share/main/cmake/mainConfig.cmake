...
if("TRUE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/spacemaster09/ode_mod/src/main)
  set(main_DEVEL_PREFIX /home/spacemaster09/ode_mod/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/spacemaster09/ode_mod/install)
...
if(NOT "/home/spacemaster09/ode_mod/src/main/include" STREQUAL "")
  set(main_INCLUDE_DIRS "")
  set(_include_dirs "/home/spacemaster09/ode_mod/src/main/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/spacemaster09/ode_mod/src/main/${idir}'.  Ask the maintainer 'Your Name <you@example.com>' to fix it.")
    endif()
